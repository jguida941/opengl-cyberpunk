...
void SceneManager::LoadSceneTextures()
{
	...
	// brick texture for the pyramid
	bReturn = CreateGLTexture(
		"textures/brick.ppm",
		"brick");

	// wood texture for the base plane
	bReturn = CreateGLTexture(
		"textures/wood.ppm",
		"wood");

	// basketball texture for the sphere
	bReturn = CreateGLTexture(
		"textures/basketball.ppm",
		"basketball");
...
void SceneManager::RenderScene()
{
	...
	// set the texture for the base plane
	...
	// set the basketball texture for the sphere
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.3f, 3.5f, 2.0f);
	...
	// set the brick texture for the pyramid
